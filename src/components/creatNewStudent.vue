    ...
    <div class='floor floor2 clear'>
      ...
      <div class='container containerfloor2'>
        ...
        <div class='alertSelectClass' v-show='floorTwoVShow'>
          <alertform @canceled='floorTwoClickCancel' @submitThird='floorTwoClickSubmit' :school='floorOneRender[0]' :profession='floorOneRender[1]'></alertform>
        </div>
      ...
      <div class='container floor4Container'>
        ...
        <div class='floor4Alert' v-show='floor4Show'>
          ...
          <div class='floor4AlertBody'>
            <alertThreePart @canceled='floorFourClickCancel' @submitThird='floorFourClickSubmit' :showNum='floor4ArletNum'></alertThreePart>
            <alertTwoPart @canceled='floorFourClickCancel' @submitThird='floorFourClickSubmit' :showNum='floor4ArletNum'></alertTwoPart>
            <alertFourPart @canceled='floorFourClickCancel' @submitThird='floorFourClickSubmit' :showNum='floor4ArletNum'></alertFourPart>
          </div>
        </div>
        <div></div>
      </div>
...
<script>
import { isMobil, isSelected, isID, isNormalText } from "./mjjTools/reg.js";
  ...
  mounted() {
    ...
    this.$axios
      ...
      .then(function(res) {
        ...
        that.floorOneRender.splice(1, 1, newarr);
      })
      .catch(function(res) {});
  },
  mounted() {},
  ...
  methods: {
    ...
    floorTwoClickSubmit: function(obj) {
      ...
      temp.date =
        ...
        ":" +
        new Date().getSeconds();
        this.floor2tableData.push(temp)
      //  var d=new Date();
